                ...
                <div class="card-deck mb-3 text-center">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" name="pit-lenght" class="form-control" placeholder="Длина (см)">

                            <p class="text-dark">Глубина ямы</p>
                            <input type="text" name="pit-depth" class="form-control" placeholder="Глубина (см)">

                            <p class="text-dark">Ширина ямы</p>
                            <input type="text" name="pit-width" class="form-control" placeholder="Ширина (см)">
